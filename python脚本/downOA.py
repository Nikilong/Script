...
#根据传进来的是文件夹路径(ProjectPackage)还是url来做判断,从而提取masp的url也不一样
...
#0.判断模式
source_mode = 'SOURCE_PACK' if '/ProjectPackage/' in sys.argv[1] else 'SOURCE_URL'
print source_mode

if source_mode == 'SOURCE_PACK':
...
if source_mode == 'SOURCE_PACK':
    dir_path = '/Users/Longcq/Downloads/jenkinsDownload/pack_%s_%s'%(projectName,timeStr)
elif source_mode == 'SOURCE_URL':
    dir_path = '/Users/Longcq/Downloads/jenkinsDownload/url_%s'%(timeStr)
